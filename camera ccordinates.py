...
cap=cv2.VideoCapture(0)# number 0 is camera connected to computer , change for different camera
cm_to_pixel=11.3/640.0# 11.3 this is width what camera can collect,depends from high,measure your own width
